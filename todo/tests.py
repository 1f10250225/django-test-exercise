...
class TaskModelTestCase(TestCase):
    def test_create_task1(self):
        due = timezone.make_aware(datetime(2026, 6, 25, 12, 0, 0))
    ...
    def test_is_overdue(self):
        due = timezone.make_aware(datetime(2026, 6, 25, 23, 59, 59))
...
class TaskViewTestCase(TestCase):
    def test_index_view_get(self):
        ...
        self.assertEqual(response.template[0], 'todo/index.html')
